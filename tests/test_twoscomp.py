...
def test_specific_cases(size, val_in, val_out):
    data = np.array([val_in] * TEST_ARRAY_SIZE, dtype=f"uint{bits_to_wordsize(size)}")
    assert list(twoscomp(data, size)) == [val_out] * TEST_ARRAY_SIZE
