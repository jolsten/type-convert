...
TEST_CASES = (
    ...
    # (0x00, 1, 0b11111111111111111111111, (-1-2**-23) * 2**-1),        # These three tests appear to be wrong
    # (0x00, 1, 0b11111111111111111111110, (-1-2**-22) * 2**-1),        # exp = 0 should yield 2**0, not 2**-1
